    ...
    def run(self):
        ...
        while True:
            try:
                ...
                # img = cv2.imread("pic/cobrapose/1.jpg")
                img = cv2.flip(img, 1)
                ...
                if len(lmList) != 0:
                    ...
                    if int(elbowAngle) > 140 and int(legAngle) > 160 and int(hipAngle) < 160 and int(heelAngle) > 120:
                        startPosition = True
                        print("true")
                        ...
                        if startPosition:
                            ...
                            if hipAngle > 170:
                                hipCorrection = "Stretch your lower back more"

                            if elbowAngle < 140:
                                elbowCorrection = "extend your arms more"

                            if spineAngle < 110:
                                spineCorrection = "look up"

                            print(time.time())

                    corrections = [legCorrection, hipCorrection, elbowCorrection, spineCorrection]
