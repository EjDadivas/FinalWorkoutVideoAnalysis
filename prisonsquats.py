                            ...
                            if direction == 0:
                                ...
                                for key, value in maxTopLegAngle.items():
                                    if max(value) < 140:
                                        ...
                                        text.append(f"{legUpCorrection1} at {math.ceil(count)}")
                                        corrections.append(legUpCorrection1)
                                    if max(value) > 180:
                                        legUpCorrection2 = "don't lock your knees"
                                        text.append(f"{legUpCorrection2} at {math.ceil(count)}")
                                        corrections.append(legUpCorrection2)
...
if __name__ == "__main__":
    ...
    ui = PrisonerSquats("prisonersquats", "a")
