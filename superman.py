                    ...
                    if int(legAngle) > 150 and int(elbowAngle) > 150:
                        ...
                        if int(count) > 0:
                            ...
                            for key, value in maxSpineUpAngle.items():
                                if max(value) < 140:
                                    spineUpCorrection = "Make your back higher"
                                    text.append(f"{spineUpCorrection} at {math.ceil(count)}")
                                    corrections.append(spineUpCorrection)

                            for key, value in maxHipAngle.items():
                                if max(value) < 140:
                                    hipUpCorrection2 = "Make your hips higher"
                                    text.append(f"{hipUpCorrection2} at {math.ceil(count)}")
                                    corrections.append(hipUpCorrection2)
                            ...
                            for key, value in maxSpineDownAngle.items():
                                if max(value) < 160:
                                    spineDownCorrection = "Go Lower and Straighen your back"
                            ...
                            for key, value in minHipAngle.items():
                                if min(value) < 160:
                                    hipDownCorrection = "Straigthen your hips"
                                    text.append(f"{hipDownCorrection} at {math.ceil(count)}")
                                    corrections.append(hipDownCorrection)
