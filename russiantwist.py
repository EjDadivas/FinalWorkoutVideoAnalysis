                    ...
                    if int(legAngle) in range(90, 160) and int(legAngle) in range(90, 160):
                        ...
                        if int(count) > 0:
                            ...
                            if int(hipAngle) > 130:
                                ...
                                text.append(f"{hipCorrection1} at {math.ceil(count)}")
                                corrections.append(hipCorrection1)

                            if int(hipAngle) < 60:
                                hipCorrection2 = "Don't over bend your hips"
                                text.append(f"{hipCorrection2} at {math.ceil(count)}")
                                corrections.append(hipCorrection2)

                            if int(legAngle) > 160:
                                legCorrection2 = "Don't over extend your legs"
                                text.append(f"{legCorrection2} at {math.ceil(count)}")
                                corrections.append(legCorrection2)

                            if int(legAngle) < 60:
                                legCorrection1 = "Don't over bend your legs"
                                text.append(f"{legCorrection1} at {math.ceil(count)}")
                                corrections.append(legCorrection1)
                            ...
                            if direction == 0:
                                ...
                                for key, value in maxSpineUpAngle.items():
                                    if max(value) < 150:
                                        ...
                                        text.append(f"{SpineUpCorrection} at {math.ceil(count)}")
                                        corrections.append(SpineUpCorrection)
                            ...
                            if direction == 1:  # going up
                                ...
                                for key, value in minSpineDownAngle.items():
                                    ...
                                    if min(value) > 140:
                                        ...
                                        text.append(f"{spineDownCorrection} at {math.ceil(count)}")
                                        corrections.append(spineDownCorrection)
...
if __name__ == "__main__":
    ...
    ui = RussianTwist("russiantwist", "2")
